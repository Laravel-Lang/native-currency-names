...
it('checks default sorting', function (string $locale): void {
...
it('checks sorting by key', function (string $locale): void {
...
it('checks sorting by value', function (string $locale): void {
